$( document ).ready(function() {
    ...
    allImages = {
        "numberOfimagesToShow": 8,                  // definisce quante immagini mostrare
        "numberOfimagesToShowOnLoadmore": 4,        // definisce quante immagini mostrare al loadmore
        "images":   
            [
                {
    ...
    //     for(var i = numberOfImagesShowed; i < allImagesTemp.length; i++) {
